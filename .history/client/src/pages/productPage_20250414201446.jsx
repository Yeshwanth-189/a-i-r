...
const ProductPage = () => {
  ...
  return (
    <div className="w-full px-4 md:px-6 py-6 grid grid-cols-1 md:grid-cols-3 gap-x-4">
      {/* Left: Main Product */}
      <div className="md:col-span-1.5 space-y-4 text-justify leading-relaxed tracking-wide">
